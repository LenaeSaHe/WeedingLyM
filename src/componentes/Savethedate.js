function Savethedate({ invitado }) {
  return (
    <section class="contB" id="secDate">
      <div class="cristalSave" id="contDate">
        <div class="txtTitles">Save the date</div>
        <p class="txtParagraph w-50">
        ...
        <small class="hrSave txtParagraph">14:00 hrs.</small>
      </div>
    </section>
  );
}
